...
java -cp crawler.jar:flame.jar:kvs.jar:webserver.jar:log4j_lib/*:lucene_lib/*:tika_lib/* cis5550.flame.FlameSubmit "$COORDINATOR" jobs.jar cis5550.test.KvsBenchmark w1/pt-crawl &
