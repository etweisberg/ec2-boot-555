...
java -Xms24g -Xmx24g -cp crawler.jar:flame.jar:kvs.jar:webserver.jar:log4j_lib/*:lucene_lib/* cis5550.flame.FlameSubmit "$COORDINATOR" jobs.jar cis5550.jobs.TfIdfEC2 &
